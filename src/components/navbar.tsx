                  ...
                  <nav>
                    <ul className="site-menu-main px-0 lg:flex lg:items-center lg:mb-0 lg:pl-0">
                      {NAVIGATION?.map((item, i) => (
                        <li
                          key={i}
                          className="font-normal list-none nav-item-has-children group/submenu relative py-[30px] px-[15px]"
                        >
                          <Link href={item.href} className="block">
                            <span className="menu-item-text relative flex items-center">
                              ...
                              <span className="absolute left-0 bottom-0 w-full h-0.5 bg-blue-600 transform scale-x-0 origin-center transition-transform duration-300 ease-[cubic-bezier(0.4,0,0.2,1)] group-hover/submenu:scale-x-100"></span>
                            </span>
                          </Link>
                          ...
                          {item.submenu && item.submenu.length > 0 && (
                            <ul
                              className={cn(
                                "absolute left-0 top-full mt-2 w-full bg-white shadow-lg rounded-lg overflow-hidden origin-top",
                                "transition-all duration-300 ease-out opacity-0 invisible scale-95 translate-y-[-10px]",

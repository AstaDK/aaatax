...
export default function Help() {
  return (
    <div className="mx-auto flex max-w-4xl flex-col items-center rounded-lg bg-gradient-to-tr from-navy via-blue-600 to-navy-hover p-4 text-center md:rounded-xl md:p-6 lg:p-8">

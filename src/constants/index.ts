...
export const REASONS = [
  {
    title: "Efficiency",
    description:
      "Save time and resources by allowing our professionals to serve your needs.",
    icon: Clock,
  },
  {
    title: "Confidence",
    description:
      "Gain confidence in your financial reports knowing they are reviewed and prepared by professionals.",
    icon: ShieldCheck,
  },
  {
    title: "Trust",
    description:
      "Access to a trusted source to consult with on your organization.",
    icon: Users,
  },
  {
    title: "Growth",
    description:
      "Reach new potential knowing you have the full support of our professionals.",
    icon: TrendingUp,
  },
  {
    title: "Compliance",
    description:
      "Ensure compliance with local and federal agencies to avoid penalties.",
    icon: ShieldCheck,
  },
  {
    title: "Knowledge",
    description:
      "Boost your understanding of accounting and finance to assist in your business decisions.",
    icon: BookOpen,
  },
];
